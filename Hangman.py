...
class Hangman(arcade.Window):
    ...
    def __init__(self):
        ...
        self.success_sound = arcade.load_sound("sounds/score.wav")
        self.fail_sound = arcade.load_sound("sounds/fail.wav")
        self.no_action_sound = arcade.load_sound("sounds/switch38.wav")
    ...
    def on_key_press(self, key, modifiers):
        ...
        if chr(key) not in CHOSEN_WORD:
            ...
            arcade.play_sound(self.no_action_sound)
    ...
    def on_draw(self):
        ...
        arcade.draw_text("(c) 2018 Daniel Sitali", 600, 20, arcade.color.BLACK)
